...
export default {
	...
	theme: {
		...
		extend: {
			...
			backgroundImage: {
				'institutional-gradient': 'var(--institutional-gradient)',
				'professional-gradient': 'var(--professional-gradient)',
			...
			fontFamily: {
				'institutional': ['Helvetica', 'Arial', 'sans-serif'],
				'financial': ['Calibri', 'Arial', 'sans-serif']
			}
		}
	},
